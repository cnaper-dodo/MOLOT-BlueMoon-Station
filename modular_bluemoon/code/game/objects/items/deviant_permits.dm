...
/obj/item/clothing/accessory/permit/special/deviant/lust/slavers
	...
	похищение членов экипажа с использованием имещюегося у них снаряжения. При нарушении любой статьи кода X05, X01, X07 \
	со стороны обладателя разрешения - Службе Безопасности всегда нужно расценивать как нарушение как 105, 101 и 107 соответственно."
