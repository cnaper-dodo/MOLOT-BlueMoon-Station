...
/obj/structure/chair/x_stand
	...
	var/static/mutable_appearance/xstand_overlay = mutable_appearance('modular_bluemoon/icons/obj/structures/bdsm_furniture.dmi', "xstand_overlay", LYING_MOB_LAYER)
