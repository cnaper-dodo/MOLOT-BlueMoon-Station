...
/datum/emote/sound/human
	...
	var/sound = 'sound/arcade/Boom.ogg'
...
/datum/emote/sound/human/can_run_emote(mob/living/user, status_check)
	. = ..()
...
// Run audio emote
/datum/emote/sound/human/run_emote(mob/user, params)
	. = ..()
...
/datum/emote/sound/human/burp/run_emote(mob/user, params, type_override, intentional)
	...
	// User is not muzzled
		...
		sound = pick('modular_splurt/sound/voice/burps/belch1.ogg','modular_splurt/sound/voice/burps/belch2.ogg','modular_splurt/sound/voice/burps/belch3.ogg','modular_splurt/sound/voice/burps/belch4.ogg',
...
/datum/emote/sound/human/carbon/moan/run_emote(mob/user, params, type_override, intentional) //I can't not port this shit, come on.
